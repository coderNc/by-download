                ...
                metadata_json=json.dumps(
                    {
                        ...
                        "format_ext": download_request.format_ext,
                        "video_codec": download_request.video_codec,
                        "audio_codec": download_request.audio_codec,
                    }
                ),
                created_at=now,
            )
        ...
        async with self.semaphore:
            ...
            async with async_session() as session:
                ...
                if request_data is None:
                    request_data = DownloadRequest(
                        ...
                        format_ext=metadata.get("format_ext"),
            ...
            try:
                download_result = await ytdlp_wrapper.download(
                    ...
                    format_ext=request_data.format_ext,
                    video_codec=request_data.video_codec,
                    audio_codec=request_data.audio_codec,
